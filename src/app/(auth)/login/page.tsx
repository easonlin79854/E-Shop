  ...
  return (
    <div className="max-w-md mx-auto mt-10">
      ...
      {oauthError === 'OAuthAccountNotLinked' && (
        <div className="bg-yellow-50 dark:bg-yellow-900/30 text-yellow-800 dark:text-yellow-300 p-3 rounded-md text-sm mb-4">
      ...
      <div className="mt-4 flex flex-col gap-3">
        <button
          ...
          className="flex items-center justify-center gap-3 w-full border dark:border-gray-600 rounded-md px-4 py-2.5 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors text-sm font-medium text-gray-700 dark:text-gray-200"
        >
          {/* Google icon */}
